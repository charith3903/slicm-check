                    ...
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <div class="card shadow">
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tr>
                                    <th>Advanced Certificate in Solid Waste Management</th>
                                </tr>
                                </thead>
                                <tbody>
                                <tr>
                                    <td>Supervise solid waste operational workforce</td>
                                </tr>
                                <tr>
                                    <td>Maintaintools, equipment & material of solid waste operations</td>
                                </tr>
                                <tr>
                                    <td>Ensure appropriate solid waste collection</td>
                                </tr>
                                <tr>
                                    <td>Supervise transportation & unloading of solid waste</td>
                                </tr>
                                <tr>
                                    <td>Ensure appropriate segregation, storing & recycling of solid waste</td>
                                </tr>
                                <tr>
                                    <td>Ensure systematic composting process</td>
                                </tr>
                                <tr>
                                    <td>Ensure systematic biogas process</td>
                                </tr>
                                <tr>
                                    <td>Ensure sanitary land filling operations</td>
                                </tr>
                                <tr>
                                    <td>Perform selling activities</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
