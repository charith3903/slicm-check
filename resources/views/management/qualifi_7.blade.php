...
<head>
    <meta charset="utf-8">
    <title>QUALIFI LEVEL 7 Diploma in Logistics and Supply Chain Crisis Management</title>
        ...
        <div class="container-fluid bg-primary py-5 bg-header" style="margin-bottom: 90px;">
            <div class="row py-5">
                <div class="col-12 pt-lg-5 mt-lg-5 text-center">
                    <h1 class="display-4 text-white animated zoomIn">QUALIFI LEVEL 7 Diploma in Logistics and Supply Chain Crisis Management</h1>
                    ...
                    <i class="far fa-circle text-white px-2"></i>
                    <a href="" class="h5 text-white">QUALIFI LEVEL 7 Diploma in Logistics and Supply Chain Crisis Management</a>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5">
                <div class="col-lg-5">
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <h1 class="mb-0">QUALIFI LEVEL 7 Diploma in Logistics and Supply Chain Crisis Management</h1>
                    </div>
                    <div class="section-title position-relative pb-3 mb-5">
                        <h4 class="mb-2">Course Information</h4>
                    </div>
                    <p class="mb-4">The level 7 Diploma in Logistics and Supply Chain Crisis Management is a qualification for aspiring strategic leaders within the logistics and 
                        supply chain sector. In particular this course looks to equip leaders with the tools necessary to build strategic resilience into their supply chains, in a 
                        blend of historic models and modern-day techniques. The Diploma is designed to provide learners with the expertise required to undertake a career as a logistics 
                        and supply chain leader and it also provides a sound basis for progression to postgraduate study.</p>
                </div>
                <div class="col-lg-7">
                    <img class="w-100" src="home/img/management/qualifi_7.png" alt="Image">
                </div>
                ...
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
                    <div class="team-item bg-light rounded overflow-hidden">
                        ...
                        <div class="text-center py-4"> 
                            ...
                            <h4 class="text-primary">9 months</h4>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 wow slideInUp" data-wow-delay="0.3s">
