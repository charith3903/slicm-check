    ...
    <div class="container-fluid py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container py-5">
            <div class="row g-5">
                ...
                <a href="home/pdf/1.pdf" class="btn btn-secondary py-2 px-4 ms-3">Click Here for Program Details</a>
                <a href="https://qualifi.net/qualifi-level-3-diploma-in-business-management" class="btn btn-primary py-2 px-4 ms-3">For more details about QUALIFI</a>
