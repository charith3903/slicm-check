                    ...
                    <div class="section-title position-relative pb-3 mb-5">
                        ...
                        <div class="card shadow">
                            ...
                            <table class="table align-items-center table-flush">
                                ...
                                <tbody>
                                <tr>
                                    <td>Communication in Care Giving</td>
                                </tr>
                                <tr>
                                    <td>Attend Domestic Affairs of the Client</td>
                                </tr>
                                <tr>
                                    <td>Maintenance of Personal Hygienic Care</td>
                                </tr>
                                <tr>
                                    <td>Maintenance of the Nutritional Status of the Client</td>
                                </tr>
                                <tr>
                                    <td>Basic Languages – English and One Other Foreign Language</td>
                                </tr>
                                <tr>
                                    <td>Basic Competencies for Work</td>
                                </tr>
                                <tr>
                                    <td>Personal Grooming, Personal Health and Hygiene</td>
                                </tr>
                                </tbody>
                            </table>
                            </div>
